...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "aiAgents.desc": "Automate everyday tasks and deploy AI agents for sales and marketing with custom workflows. Work smarter, not harder.",
    "aiAgents.cta": "Automate Your Marketing",
    "aiAgents.importance": "Teams waste 40% of their time on repetitive tasks that could be automated. AI agents can handle email sending, article publishing, lead qualification, data enrichment, and reporting 24/7 without human intervention. From chatbots that convert visitors to workflows that sync your tools, intelligent automation is no longer a luxury—it's a competitive necessity.",
    "aiAgents.feature1.title": "Task Automation",
    "aiAgents.feature1.desc": "Automate repetitive tasks like email sending, article publishing, reporting, and data collection with intelligent integrations.",
    ...
    "aiAgents.benefit1": "Save hours on repetitive everyday tasks",
    ...
    "aiAgents.faq.a1": "Almost any repetitive task: email sending, article publishing, lead scoring, social media posting, report generation, data syncing between tools, and customer support. Our AI expertise helps identify the highest-impact automation opportunities for your business.",
  ...
  pt: {
    ...
    "aiAgents.desc": "Automatize tarefas do dia a dia e implante agentes IA para vendas e marketing com workflows personalizados. Trabalhe de forma mais inteligente, não mais difícil.",
    "aiAgents.cta": "Automatize seu marketing",
    "aiAgents.importance": "Equipes desperdiçam 40% do tempo em tarefas repetitivas que poderiam ser automatizadas. Agentes de IA podem lidar com envio de emails, publicação de artigos, qualificação de leads, enriquecimento de dados e relatórios 24/7 sem intervenção humana. De chatbots que convertem visitantes a workflows que sincronizam suas ferramentas, automação inteligente não é mais um luxo—é uma necessidade competitiva.",
    "aiAgents.feature1.title": "Automação de tarefas",
    "aiAgents.feature1.desc": "Automatize tarefas repetitivas como envio de emails, publicação de artigos, relatórios e coleta de dados com integrações inteligentes.",
    ...
    "aiAgents.benefit1": "Economize horas em tarefas repetitivas do dia a dia",
