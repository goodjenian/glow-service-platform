...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "pricing.subtitle": "Transparent pricing designed to scale with your business. All prices are starting values.",
    "pricing.includes": "Includes:",
    "pricing.cta": "Request Quote",
    "pricing.popular": "Most Popular",
    "pricing.note": "All prices are starting values. The final investment varies based on complexity, objectives, content volume, integrations, and technical resources required.",
    "pricing.setup": "Initial Setup",
    "pricing.monthly": "Monthly",
    "pricing.perArticle": "per article",

    // SEO Pricing
    "seo.pricing.tier1.name": "Technical SEO + On-Page",
    "seo.pricing.tier1.desc": "Complete technical foundation and on-page optimization",
    "seo.pricing.tier1.setup": "R$ 6,000",
    "seo.pricing.tier1.maintenance": "R$ 300/mo",
    "seo.pricing.tier1.inc1": "Technical audit",
    "seo.pricing.tier1.inc2": "Indexing, performance & structure fixes",
    "seo.pricing.tier1.inc3": "On-page SEO (titles, headings, internal links)",
    "seo.pricing.tier1.inc4": "Implementation and technical support",
    "seo.pricing.tier2.name": "SEO Content Creation",
    "seo.pricing.tier2.desc": "Scalable content production and publishing",
    "seo.pricing.tier2.price": "R$ 60",
    "seo.pricing.tier2.pack": "30 articles/mo: R$ 1,800",
    "seo.pricing.tier2.inc1": "SEO-optimized content",
    "seo.pricing.tier2.inc2": "CMS publishing",
    "seo.pricing.tier2.inc3": "Meta title and description adjustments",
    "seo.pricing.tier2.inc4": "Can be contracted with or without Technical SEO",
    "seo.pricing.ideal": "Ideal for companies seeking sustainable organic growth.",

    // AI Agents Pricing
    "aiAgents.pricing.tier1.name": "AI Agents Implementation",
    "aiAgents.pricing.tier1.desc": "Standard automation setup",
    "aiAgents.pricing.tier1.setup": "R$ 2,000",
    "aiAgents.pricing.tier1.maintenance": "R$ 400/mo",
    "aiAgents.pricing.tier1.inc1": "Task automation (SEO, sales, support)",
    "aiAgents.pricing.tier1.inc2": "Integration with existing workflows",
    "aiAgents.pricing.tier1.inc3": "Continuous adjustments",
    "aiAgents.pricing.tier2.name": "Custom AI Agents",
    "aiAgents.pricing.tier2.desc": "Advanced customization and complex workflows",
    "aiAgents.pricing.tier2.price": "From R$ 8,000",
    "aiAgents.pricing.tier2.inc1": "Tailor-made project",
    "aiAgents.pricing.tier2.inc2": "Advanced AI customization",
    "aiAgents.pricing.tier2.inc3": "Complex integrations",
    "aiAgents.pricing.ideal": "Ideal for companies seeking real operational efficiency with AI.",

    // Site Express Pricing
    "siteExpress.pricing.tier1.name": "Site Express",
    "siteExpress.pricing.tier1.desc": "Fast professional website creation",
    "siteExpress.pricing.tier1.frontend": "R$ 1,000",
    "siteExpress.pricing.tier1.backend": "R$ 2,000",
    "siteExpress.pricing.tier1.maintenance": "R$ 500/mo",
    "siteExpress.pricing.tier1.inc1": "Modern layout",
    "siteExpress.pricing.tier1.inc2": "SEO-optimized structure",
    "siteExpress.pricing.tier1.inc3": "Fast deployment (days, not months)",
    "siteExpress.pricing.ideal": "Ideal for businesses needing a professional online presence quickly.",

    // Social Media Pricing
    "socialMedia.pricing.tier1.name": "Social Media Management",
    "socialMedia.pricing.tier1.desc": "Complete social media management",
    "socialMedia.pricing.tier1.price": "From R$ 2,000/mo",
    "socialMedia.pricing.tier1.inc1": "Content creation",
    "socialMedia.pricing.tier1.inc2": "Publishing schedule",
    "socialMedia.pricing.tier1.inc3": "Basic audience communication",
    "socialMedia.pricing.ideal": "Ideal for businesses looking to build consistent brand presence.",
  ...
  pt: {
    ...
    // Pricing Section
    "pricing.title": "Investimento",
    "pricing.subtitle": "Preços transparentes projetados para escalar com seu negócio. Todos os valores são a partir de.",
    "pricing.includes": "Inclui:",
    "pricing.cta": "Solicitar Orçamento",
    "pricing.popular": "Mais Popular",
    "pricing.note": "Todos os valores são a partir de. O investimento final varia conforme complexidade, objetivos, volume de conteúdo, integrações e recursos técnicos necessários.",
    "pricing.setup": "Setup Inicial",
    "pricing.monthly": "Mensal",
    "pricing.perArticle": "por artigo",

    // SEO Pricing
    "seo.pricing.tier1.name": "SEO Técnico + On-Page",
    "seo.pricing.tier1.desc": "Fundação técnica completa e otimização on-page",
    "seo.pricing.tier1.setup": "R$ 6.000",
    "seo.pricing.tier1.maintenance": "R$ 300/mês",
    "seo.pricing.tier1.inc1": "Auditoria técnica",
    "seo.pricing.tier1.inc2": "Correções de indexação, performance e estrutura",
    "seo.pricing.tier1.inc3": "SEO on-page (títulos, headings, links internos)",
    "seo.pricing.tier1.inc4": "Implementação e acompanhamento técnico",
    "seo.pricing.tier2.name": "Criação de Conteúdo SEO",
    "seo.pricing.tier2.desc": "Produção escalável de conteúdo e publicação",
    "seo.pricing.tier2.price": "R$ 60",
    "seo.pricing.tier2.pack": "30 artigos/mês: R$ 1.800",
    "seo.pricing.tier2.inc1": "Conteúdo otimizado para SEO",
    "seo.pricing.tier2.inc2": "Publicação no CMS",
    "seo.pricing.tier2.inc3": "Ajustes de meta title e description",
    "seo.pricing.tier2.inc4": "Pode ser contratado com ou sem SEO técnico",
    "seo.pricing.ideal": "Ideal para empresas que buscam crescimento orgânico sustentável.",

    // AI Agents Pricing
    "aiAgents.pricing.tier1.name": "Implementação de Agentes IA",
    "aiAgents.pricing.tier1.desc": "Setup padrão de automação",
    "aiAgents.pricing.tier1.setup": "R$ 2.000",
    "aiAgents.pricing.tier1.maintenance": "R$ 400/mês",
    "aiAgents.pricing.tier1.inc1": "Automação de tarefas (SEO, vendas, atendimento)",
    "aiAgents.pricing.tier1.inc2": "Integração com workflows existentes",
    "aiAgents.pricing.tier1.inc3": "Ajustes contínuos",
    "aiAgents.pricing.tier2.name": "Agentes IA Customizados",
    "aiAgents.pricing.tier2.desc": "Customização avançada e workflows complexos",
    "aiAgents.pricing.tier2.price": "A partir de R$ 8.000",
    "aiAgents.pricing.tier2.inc1": "Projeto sob medida",
    "aiAgents.pricing.tier2.inc2": "Customização avançada de IA",
    "aiAgents.pricing.tier2.inc3": "Integrações complexas",
    "aiAgents.pricing.ideal": "Ideal para empresas que buscam eficiência operacional real com IA.",

    // Site Express Pricing
    "siteExpress.pricing.tier1.name": "Site Express",
    "siteExpress.pricing.tier1.desc": "Criação rápida de site profissional",
    "siteExpress.pricing.tier1.frontend": "R$ 1.000",
    "siteExpress.pricing.tier1.backend": "R$ 2.000",
    "siteExpress.pricing.tier1.maintenance": "R$ 500/mês",
    "siteExpress.pricing.tier1.inc1": "Layout moderno",
    "siteExpress.pricing.tier1.inc2": "Estrutura otimizada para SEO",
    "siteExpress.pricing.tier1.inc3": "Deploy rápido (dias, não meses)",
    "siteExpress.pricing.ideal": "Ideal para empresas que precisam de presença online profissional rapidamente.",

    // Social Media Pricing
    "socialMedia.pricing.tier1.name": "Gestão de Redes Sociais",
    "socialMedia.pricing.tier1.desc": "Gestão completa de redes sociais",
    "socialMedia.pricing.tier1.price": "A partir de R$ 2.000/mês",
    "socialMedia.pricing.tier1.inc1": "Criação de conteúdo",
    "socialMedia.pricing.tier1.inc2": "Calendário de publicação",
    "socialMedia.pricing.tier1.inc3": "Comunicação básica com audiência",
    "socialMedia.pricing.ideal": "Ideal para empresas que buscam construir presença de marca consistente.",
